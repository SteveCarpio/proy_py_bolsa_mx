...
def pasoHelp():
    ...
    print(Fore.WHITE + "    /srv/apps/MisCompilados/PROY_BOLSA_MX/BMV/")
    print("")
    print(Fore.WHITE + "Ejecución:")
    print(Fore.WHITE + "    BMV_Main.py RUN-NO-EMAIL PRO")
    print("")
    ...
    print("")
    print(Fore.YELLOW + "    5) Requests.Get y Pandas: Descargar HTML de Emisores")
    print(Fore.WHITE + "       Se descargará de las URL la web HTML de los emisores filtrados")
    print("")
    print(Fore.GREEN + "    6) Pandas: Extraer información de los HTML")
    print(Fore.WHITE + "       Se busca la información necesario de los html en un dataframe para ser analizado.")
    print("")
