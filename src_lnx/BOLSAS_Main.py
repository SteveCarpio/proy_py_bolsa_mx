...
def pasoHelp():
    ...
    print(Fore.WHITE + "    /srv/apps/MisCompilados/PROY_BOLSA_MX/")
    print("")
    print(Fore.WHITE + "Ejecución:")
    print(Fore.WHITE + "    BIVA.py        RUN-NO-EMAIL [DEV|PRO] [AAAA-MM-DD]")
    print(Fore.WHITE + "    BMV_Main.py    RUN-NO-EMAIL [DEV|PRO] [AAAA-MM-DD]")
    print(Fore.WHITE + "    BOLSAS_Main.py RUN          [DEV|PRO] [AAAA-MM-DD]")
    print("")
    ...
    print(Fore.WHITE + "        con el nombre del trabajo 'BIVA_Main.py'.")
    print("")
    ...
    print(Fore.WHITE + "        con el nombre del trabajo 'BMV_Main.py'.")
    print("")
    ...
    print(Fore.WHITE + "        /srv/apps/MisCompilados/PROY_BOLSA_MX/INFORMES/")
    print("")
    ...
    print(Fore.WHITE + "        Ruta del binario: /srv/apps/MisCompilados/.cfg/chromedriver/chromedriver")
    print(Fore.WHITE + "        Para otras versiones: /srv/apps/MisCompilados/.cfg/chromedriver/139/")
    print(Fore.WHITE + "        Ruta Web: https://github.com/dreamshao/chromedriver")
    print("")
...
def mostrar_menu(par_FechasSalida):
    ...
    print(Fore.BLUE    + "4) 🔵 Enviar Email CiBanco       ")
    print(Fore.BLUE    + "5) 🔵 Crear Datos para Oracle    ")
    print("")
